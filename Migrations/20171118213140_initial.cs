        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Colaboradores_AspNetUsers_LoginId",
                        column: x => x.LoginId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Coletor1Id = table.Column<int>(nullable: false),
                    Coletor2Id = table.Column<int>(nullable: false),
                    Coletor3Id = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apontamentos_Colaboradores_Coletor1Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apontamentos_Coletor1Id",
                table: "Apontamentos",
                column: "Coletor1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Apontamentos_Coletor2Id",
                table: "Apontamentos",
                column: "Coletor2Id");

            migrationBuilder.CreateIndex(
                name: "IX_Apontamentos_Coletor3Id",
                table: "Apontamentos",
                column: "Coletor3Id");

            migrationBuilder.CreateIndex(
                name: "IX_Apontamentos_MotoristaId",
                table: "Apontamentos",
                column: "MotoristaId");

            migrationBuilder.CreateIndex(
                name: "IX_Apontamentos_VeiculoId",
                table: "Apontamentos",
                column: "VeiculoId");
